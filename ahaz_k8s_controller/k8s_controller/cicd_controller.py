...
def start_challenge_pod(teamname: str, k8s_name: str, image: str, ram: str, cpu: str, storage: str, visible_to_user: bool, networklist: list[str], taskname: str) -> None:
    config.load_kube_config()
...
def create_network_policy_allow_task(teamname: str, challengename: str, network_pods: list[str], netname: str) -> client.V1NetworkPolicy:
